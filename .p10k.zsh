{% raw %}
# Generated by Powerlevel10k configuration wizard on 2019-09-08 at 18:39 CEST.
...
() {
  ...
  # Local host foreground color
  typeset -g POWERLEVEL9K_HOST_LOCAL_FOREGROUND=${POWERLEVEL9K_OS_ICON_FOREGROUND}

  typeset -g POWERLEVEL9K_MAC_MODEL_FOREGROUND=${POWERLEVEL9K_HOST_LOCAL_FOREGROUND}
  typeset -g _mac_model_cache=
  function prompt_mac_model() {
    if [ -z "${_mac_model_cache}" ]; then
      _mac_model_cache=$(system_profiler -json SPHardwareDataType 2>/dev/null | jq -r ".SPHardwareDataType[0].machine_name")
      if [ -z "$_mac_model_cache" ]; then
        # Fallback for previous releases of macOS which don't have -json format
        _mac_model_cache=$(system_profiler SPHardwareDataType 2>/dev/null | rg --color=never 'Model Name' | sed -E 's/.*Model Name: (.*)\n?/\1/')
      fi
    fi

    p10k segment -t "${_mac_model_cache}"
  }

  function instant_prompt_mac_model() {
    prompt_mac_model
  }
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=14 # Cyan darker
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=5 # Purple
  ...
  local vcs=''
  # If on a branch...
  vcs+='${${VCS_STATUS_LOCAL_BRANCH:+%${POWERLEVEL9K_VCS_STATUS_LOCAL_BRANCH_FOREGROUND}F'${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}
  ...
  vcs+=':-${VCS_STATUS_LOCAL_BRANCH[1,12]//\%/%%}%${POWERLEVEL9K_VCS_STATUS_LOCAL_BRANCH_FOREGROUND}F…%${POWERLEVEL9K_VCS_STATUS_LOCAL_BRANCH_FOREGROUND}F${VCS_STATUS_LOCAL_BRANCH[-12,-1]//\%/%%}}}'
  # '@72f5c8a' if not on a branch.
  vcs+=':-%f%${POWERLEVEL9K_VCS_STATUS_COMMIT_FOREGROUND}F${(g::)POWERLEVEL9K_VCS_COMMIT_ICON}${VCS_STATUS_COMMIT[1,8]}}'
  # ':master' if the tracking branch name differs from local branch.
  vcs+='${${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH}:+%f:%${POWERLEVEL9K_VCS_STATUS_REMOTE_BRANCH_FOREGROUND}F${VCS_STATUS_REMOTE_BRANCH//\%/%%}}'
  # '#tag' if on a tag.
  vcs+='${VCS_STATUS_TAG:+ %${POWERLEVEL9K_VCS_STATUS_TAG_FOREGROUND}F${(g::)POWERLEVEL9K_VCS_TAG_ICON}%${POWERLEVEL9K_VCS_STATUS_TAG_FOREGROUND}F${VCS_STATUS_TAG//\%/%%}}'
  # ⇣42 if behind the remote.
  vcs+='${${VCS_STATUS_COMMITS_BEHIND:#0}:+ %${POWERLEVEL9K_VCS_STATUS_COMMITS_BEHIND_FOREGROUND}F⇣${VCS_STATUS_COMMITS_BEHIND}}'
  # ⇡42 if ahead of the remote; no leading space if also behind the remote: ⇣42⇡42.
  # If you want '⇣42 ⇡42' instead, replace '${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }' with ' '.
  vcs+='${${VCS_STATUS_COMMITS_AHEAD:#0}:+${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }%${POWERLEVEL9K_VCS_STATUS_COMMITS_AHEAD_FOREGROUND}F⇡${VCS_STATUS_COMMITS_AHEAD}}'
  # *42 if have stashes.
  vcs+='${${VCS_STATUS_STASHES:#0}:+ %${POWERLEVEL9K_VCS_STATUS_STASHES_FOREGROUND}F*${VCS_STATUS_STASHES}}'
  # 'merge' if the repo is in an unusual state.
  vcs+='${VCS_STATUS_ACTION:+ %${POWERLEVEL9K_VCS_STATUS_ACTION_FOREGROUND}F${VCS_STATUS_ACTION//\%/%%}}'
  # ~42 if have merge conflicts.
  vcs+='${${VCS_STATUS_NUM_CONFLICTED:#0}:+ %${POWERLEVEL9K_VCS_STATUS_NUM_CONFLICTED_FOREGROUND}F~${VCS_STATUS_NUM_CONFLICTED}}'
  # +42 if have staged changes.
  vcs+='${${VCS_STATUS_NUM_STAGED:#0}:+ %${POWERLEVEL9K_VCS_STATUS_NUM_STAGED_FOREGROUND}F+${VCS_STATUS_NUM_STAGED}}'
  # !42 if have unstaged changes.
  vcs+='${${VCS_STATUS_NUM_UNSTAGED:#0}:+ %${POWERLEVEL9K_VCS_STATUS_NUM_UNSTAGED_FOREGROUND}F!${VCS_STATUS_NUM_UNSTAGED}}'
  # ?42 if have untracked files. It's really a question mark, your font isn't broken.
  # See POWERLEVEL9K_VCS_UNTRACKED_ICON below if you want to use a different icon.
  # Remove the next line if you don't want to see untracked files at all.
  vcs+='${${VCS_STATUS_NUM_UNTRACKED:#0}:+ %${POWERLEVEL9K_VCS_STATUS_NUM_UNTRACKED_FOREGROUND}F'${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}'${VCS_STATUS_NUM_UNTRACKED}}'
  ...
  # Tag icon. Set this parameter to $'\uF02B' for the popular Powerline tag icon.
  ...
  typeset -g POWERLEVEL9K_VCS_STATUS_LOCAL_BRANCH_FOREGROUND=2
  typeset -g POWERLEVEL9K_VCS_STATUS_COMMIT_FOREGROUND=2
  typeset -g POWERLEVEL9K_VCS_STATUS_REMOTE_BRANCH_FOREGROUND=2
  typeset -g POWERLEVEL9K_VCS_STATUS_TAG_FOREGROUND=2
  typeset -g POWERLEVEL9K_VCS_STATUS_COMMITS_BEHIND_FOREGROUND=2
  typeset -g POWERLEVEL9K_VCS_STATUS_COMMITS_AHEAD_FOREGROUND=2
  typeset -g POWERLEVEL9K_VCS_STATUS_STASHES_FOREGROUND=2
  typeset -g POWERLEVEL9K_VCS_STATUS_ACTION_FOREGROUND=4
  typeset -g POWERLEVEL9K_VCS_STATUS_NUM_CONFLICTED_FOREGROUND=1
  typeset -g POWERLEVEL9K_VCS_STATUS_NUM_STAGED_FOREGROUND=3
  typeset -g POWERLEVEL9K_VCS_STATUS_NUM_UNSTAGED_FOREGROUND=3
  typeset -g POWERLEVEL9K_VCS_STATUS_NUM_UNTRACKED_FOREGROUND=6

  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=${POWERLEVEL9K_VCS_STATUS_LOCAL_BRANCH_FOREGROUND}
  # Custom icon.
